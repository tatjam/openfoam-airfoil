...
alpha = deg2rad(12.0);       % Angle of attack (in radians)
NACA = [0 0 1 8];     % NACA 4-digit designation as a row vector;

% Mesh dimensions
scale = 1;            % Scaling factor
H = 8;                % *Half* height of channel
W = 0.5;              % *Half* depth of foil (y-direction)
D = 12;               % Length of downstream section
...
Nleading = round((x(C_max_idx)/c)*Nx)+1;
...
% Open file
fo = fopen('system/blockMeshDict', 'w');
